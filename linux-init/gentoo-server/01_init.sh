...
# copy stage tarball
timestamp='20160603'
wget http://mirrors.aliyun.com/gentoo/releases/amd64/autobuilds/${timestamp}/systemd/stage3-amd64-systemd-${timestamp}.tar.bz2
tar jxvpf stage3-amd64-systemd-${timestamp}.tar.bz2 --xattrs -C /mnt/gentoo
